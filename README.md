...
Open `settings.py` and replace every `000000000000000000` placeholder with the real ID. See the Configuration section below for a full walkthrough.
...
Go to discord.com/developers/applications, select your bot → Bot tab:
✅ Server Members Intent
✅ Message Content Intent
7. Invite the bot
...
Connect to MongoDB and create all indexes automatically
Load all cogs
